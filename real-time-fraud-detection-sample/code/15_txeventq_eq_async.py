...
async def enqueue_from_csv(csv_path):
    ...
    for data in data_tuples:
        ...
        await txeventqueue.enqone(connection.msgproperties(payload=transaction_payload))
...
if __name__ == "__main__":
    ...
    asyncio.run(enqueue_from_csv(csv_path))
